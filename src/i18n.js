...
var i18n =
{
	...
	_texts:
	{
		ru:
		{
			...
			'rv.title':                 'Реклама за награду',
			'rv.watch':                 '📺 Смотреть рекламу',
			'rv.cancel':                'Отмена',
			'rv.desc.undo':             'Посмотри рекламу и получи 3 отмены хода',
			'rv.desc.hint':             'Посмотри рекламу и получи подсказку',
			'rv.desc.extra-tube':       'Посмотри рекламу и добавь пустую пробирку',
			'rv.desc.bomb':             'Посмотри рекламу и активируй бомбу',
			'rv.desc.magnet':           'Посмотри рекламу и активируй магнит',
		},
		en:
		{
			...
			'daily.win':           'Challenge Complete!',
			'endless.win':         'Well Done!',
			...
			'rv.title':                 'Watch Ad for Reward',
			'rv.watch':                 '📺 Watch Ad',
			'rv.cancel':                'Cancel',
			'rv.desc.undo':             'Watch an ad to get 3 undo moves',
			'rv.desc.hint':             'Watch an ad to get a hint',
			'rv.desc.extra-tube':       'Watch an ad to add an empty tube',
			'rv.desc.bomb':             'Watch an ad to activate the bomb',
			'rv.desc.magnet':           'Watch an ad to activate the magnet',
		},
	},
